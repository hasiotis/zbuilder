...
class vmProvider(object):
    ...
    def create_nic(self, h, v):
        ...
        nicParams = {
            "location": v["location"],
            "ip_configurations": [{"name": nicName, "subnet": {"id": subnet.id}}],
        }
    ...
    def create_vm(self, h, v, nic):
        ...
        vmParams = {
            ...
            "hardware_profile": {"vm_size": v["vm_size"]},
            "storage_profile": {
                "image_reference": {
    ...
    def build(self, hosts):
        ...
        for h, v in hosts.items():
            if v["enabled"]:
                ...
                ip_configurations = self.netClient.network_interfaces.get(
        ...
        for h, v in hosts.items():
            if hosts[h]["enabled"]:
                ...
                try:
                    ...
                    net_del_poller = self.netClient.network_interfaces.delete(
                        nicInfo["resource_group"], nicInfo["resource_name"]
                    )
                    net_del_poller.wait()
